...
<script src="//maps.googleapis.com/maps/api/js?key=AIzaSyAhGnGUgmO-dC2r26uWjidj-4t55jp4xeA&amp;libraries=places"></script>
<!--<script src="//maps.googleapis.com/maps/api/js?key=AIzaSyA25q00uzEkwuUUPIMrO2uwpA2QN3QRi64&amp;libraries=places"></script>-->
	<?php wp_head(); ?>
</head>
