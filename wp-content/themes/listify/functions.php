...
function listify_scripts() {
    ...
    wp_enqueue_style( 'listify', get_template_directory_uri() . '/css/style.min.css', array(), 20170412 );
    ...
    wp_enqueue_script( 'listify', get_template_directory_uri() . '/js/app.min.js', $deps, 20161227, true );
...
function listify_cover( $class, $args = array() ) {
	...
	} else if ( ! in_the_loop() && is_singular( 'post' ) ) {
...
/** Standard Includes */
$includes = array(
	// @link https://github.com/Astoundify/listify/issues/1585
...
$integrations = apply_filters( 'listify_integrations', array(
    ...
    'wp-job-manager-favorites' => defined( 'WPJMF_VERSION' ),
    'wp-job-manager-listing-labels' => defined( 'WPJMLL_VERSION' ),

    'woocommerce' => class_exists( 'Woocommerce' ),
    'woocommerce-bookings' => class_exists( 'WC_Bookings' ),
    'woocommerce-social-login' => class_exists( 'WC_Social_Login' ),
    'woocommerce-simple-registration' => class_exists( 'WooCommerce_Simple_Registration' ),
...
// Set other options for Custom Post Type
    ...
    $args = array(
        'label'               => __( 'rorm'),
        'description'         => __( 'Form news and reviews'),
        'labels'              => $labels,
