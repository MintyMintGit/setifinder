        ...
        xhr[index] = $.ajax( {
            ...
            success: function ( result ) {
                if ( result ) {
                    ...
                    jQuery('ul.job_listings li').each(function(indx, element){
                        var temp = jQuery(element);
                        console.log("run each");
                        if(!temp.hasClass("no_job_listings_found")) {
                            console.log("run if");
                            var latitude = parseFloat(temp.attr('data-latitude').trim());
                            var longitude = parseFloat(temp.attr('data-longitude').trim());
                            if(latitude && longitude) {
                                console.log("run if lat and long");
